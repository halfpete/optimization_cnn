...
int do_benchmark(int argc, char** argv) {
  ...
  free(samples);
  printf("Time for layer0 => %lu\n", timestamp0);
  printf("Time for layer1 => %lu\n", timestamp1);
  printf("Time for layer2 => %lu\n", timestamp2);
  printf("Time for layer3 => %lu\n", timestamp3);
  printf("Time for layer4 => %lu\n", timestamp4);
  printf("Time for layer5 => %lu\n", timestamp5);
  printf("Time for layer6 => %lu\n", timestamp6);
  printf("Time for layer7 => %lu\n", timestamp7);
  printf("Time for layer8 => %lu\n", timestamp8);
  printf("Time for layer9 => %lu\n", timestamp9);
  printf("Time for layer10 => %lu\n", timestamp10);
